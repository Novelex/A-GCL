#!/bin/bash
#SBATCH --job-name=s17swC
#SBATCH --partition=gpu-l40s,gpu-h100
#SBATCH --array=0-521%60
#SBATCH --cpus-per-task=4
#SBATCH --mem=8G
#SBATCH --time=04:00:00
#SBATCH --output=/users/3171356m/A-GCL/audit/s17/logs/sweep/C_%A_%a.out
#SBATCH --error=/users/3171356m/A-GCL/audit/s17/logs/sweep/C_%A_%a.err
# Stage C: mALFF-90 MLP alone, 29 folds x 18 chunks = 522 tasks.
set -euo pipefail
...
"
export SWEEP_NPAR=4
$PY -u $S/taskC.py $SLURM_ARRAY_TASK_ID
