#!/bin/bash
#SBATCH --job-name=s17swFin
#SBATCH --partition=gpu-l40s,gpu-h100
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --time=04:00:00
#SBATCH --output=/users/3171356m/A-GCL/audit/s17/logs/sweep/final.out
#SBATCH --error=/users/3171356m/A-GCL/audit/s17/logs/sweep/final.err
set -euo pipefail
...
"
$PY -u $S/aggBC.py && $PY -u $S/report.py
