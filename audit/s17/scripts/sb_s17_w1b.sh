...
#SBATCH --output=/users/3171356m/A-GCL/audit/s17/logs/w1b_%a.out
#SBATCH --error=/users/3171356m/A-GCL/audit/s17/logs/w1b_%a.err
...
#
# 108 tasks = Wave 1b: same 4 arms x 3 seeds x 9 folds, probe reported at 3 widths.
...
t=W.wave1b_tasks('prod'); assert len(t)==108, f'FROZEN GRID CHANGED: {len(t)} tasks, expected 108. STOP.'
...
trap _fwd USR1
/users/3171356m/A-GCL/.venv/bin/python -u $S/s17_w1b_run.py $SLURM_ARRAY_TASK_ID &
PY_PID=$!
while :; do
