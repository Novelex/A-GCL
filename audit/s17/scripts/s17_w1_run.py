"""S17 Wave 1 array task: ONE fold per SLURM task. Writes only audit/s17/runs/prod/.
...
Usage (from the array):  python s17_w1_run.py $SLURM_ARRAY_TASK_ID
"""
